...
"VB", "SB", "Y", "R"), row.names = c(NA, -34L), class = "data.frame"), 
    ...
    "P"), row.names = c(NA, -30L), class = "data.frame"), Dev = structure(list(
        sigmaR = structure(c(0.5, 1), .Names = c("Initial", "Annual"
        ...
        "2000", "2001", "2002", "2003"))), .Names = c("sigmaR", 
    ...
    292.159, 298.522, 342.267, 348.371)), .Names = c("Series", 
    "Year", "Obs", "CV", "Fit"), row.names = c(NA, -34L), class = "data.frame"), 
...
"B", "Sel", "Dev", "Survey", "CAc", "CAs"), call = quote(importCol(res.file = "c:/scape/example/cod.res", 
    Dev = TRUE, Survey = TRUE, CAc = TRUE, CAs = TRUE)), scape.version = "2.0-1", info = "", class = "scape")
